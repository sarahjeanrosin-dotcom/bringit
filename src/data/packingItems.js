...
export const ALL_ITEMS = [
  ...
  { id:'d11', name:'International driving permit',   category:'documents', qty:flat(1),      cond:t=>t.isInternational && t.travelMode==='car' },
  ...
  { id:'c13', name:'Swimsuit',                category:'clothing', qty:flat(2),        cond:t=>t.weather==='hot'||t.activities.includes('beach')||t.activities.includes('swimming')||t.accommodation==='cruise' },
  { id:'c14', name:'Shorts',                  category:'clothing', qty:perDay(0.5,2),  cond:t=>t.weather==='hot'||t.activities.includes('beach') },
  { id:'c15', name:'Sun hat / baseball cap',  category:'clothing', qty:flat(1),        cond:t=>t.weather==='hot'||t.activities.includes('beach')||t.activities.includes('hiking') },
  ...
  { id:'c18', name:'Athletic / running shoes',category:'clothing', qty:perPerson(1),   cond:t=>t.activities.some(a=>['hiking','sports','running','yoga'].includes(a)) },
  { id:'c19', name:'Dress shoes / smart casual shoes', category:'clothing', qty:perPerson(1), cond:t=>t.activities.includes('dining')||t.activities.includes('nightlife')||t.accommodation==='cruise' },
  ...
  { id:'t5',  name:'Sunscreen SPF 50+',       category:'toiletries', qty:perPerson(1), cond:t=>t.weather==='hot'||t.activities.some(a=>['beach','hiking'].includes(a)) },
  ...
  { id:'t12', name:'Motion sickness medication',  category:'toiletries', qty:flat(1),  cond:t=>['plane','cruise'].includes(t.travelMode) },
  { id:'t13', name:'First aid kit',           category:'toiletries', qty:flat(1),      cond:t=>t.activities.some(a=>['hiking','camping'].includes(a))||t.accommodation==='camping' },
  { id:'t14', name:'Insect repellent',        category:'toiletries', qty:flat(1),      cond:t=>t.activities.some(a=>['hiking','camping'].includes(a))||t.weather==='hot' },
  ...
  { id:'t18', name:'Blister plasters / moleskin', category:'toiletries', qty:flat(1),  cond:t=>t.activities.includes('hiking') },
  ...
  { id:'e6',  name:'Noise-canceling headphones', category:'electronics', qty:flat(1),   cond:t=>['plane','train'].includes(t.travelMode) },
  { id:'e7',  name:'Camera & memory cards',   category:'electronics', qty:flat(1),      cond:t=>t.activities.some(a=>['photography','sightseeing'].includes(a)) },
  { id:'e8',  name:'GoPro / waterproof camera', category:'electronics', qty:flat(1),    cond:t=>t.activities.some(a=>['beach','swimming','skiing','surfing'].includes(a)) },
  ...
  { id:'g6',  name:'Day backpack',            category:'gear', qty:flat(1),      cond:t=>t.activities.some(a=>['hiking','sightseeing'].includes(a)) },
  { id:'g7',  name:'Quick-dry travel towel',  category:'gear', qty:perPerson(1), cond:t=>['camping','hostel'].includes(t.accommodation)||t.activities.includes('beach') },
  ...
  { id:'g14', name:'Dry bag / waterproof pouch', category:'gear', qty:flat(1),   cond:t=>t.activities.some(a=>['beach','hiking','swimming'].includes(a)) },
  { id:'g15', name:'Snorkel & mask',          category:'gear', qty:perPerson(1), cond:t=>t.activities.includes('swimming')&&t.weather==='hot' },
  { id:'g16', name:'Luggage tags',            category:'gear', qty:flat(2),      cond:t=>t.travelMode==='plane' },
  { id:'g17', name:'Portable luggage scale',  category:'gear', qty:flat(1),      cond:t=>t.travelMode==='plane' },
  { id:'g18', name:'Money belt / anti-theft pouch', category:'gear', qty:perPerson(1), cond:t=>t.isInternational },
  { id:'g19', name:'Car emergency kit',       category:'gear', qty:flat(1),      cond:t=>t.travelMode==='car' },
  ...
  { id:'g22', name:'Binoculars',              category:'gear', qty:flat(1),      cond:t=>t.activities.some(a=>['hiking','wildlife'].includes(a)) },
  ...
  { id:'k9',  name:'Car seat',                category:'kids', qty:flat(1), cond:t=>t.hasKids&&t.travelMode==='car' },
  ...
  { id:'k12', name:'Swim arm bands / life jacket', category:'kids', qty:flat(1), cond:t=>t.hasKids&&t.activities.some(a=>['beach','swimming'].includes(a)) },
  ...
  { id:'f2',  name:'Electrolyte packets',     category:'food', qty:flat(1), cond:t=>t.activities.includes('hiking')||t.weather==='hot' },
  { id:'f3',  name:'Protein bars',            category:'food', qty:flat(1), cond:t=>t.activities.includes('hiking') },
  ...
  // COMFORT
  { id:'co1', name:'Neck pillow',             category:'comfort', qty:perPerson(1), cond:t=>['plane','train'].includes(t.travelMode)||t.days>3 },
  { id:'co2', name:'Sleep mask',              category:'comfort', qty:perPerson(1), cond:t=>t.travelMode==='plane'||t.days>3 },
  { id:'co3', name:'Earplugs',               category:'comfort', qty:perPerson(1), cond:t=>t.travelMode==='plane'||t.accommodation==='hostel' },
  ...
  { id:'co7', name:'Downloaded movies / shows (offline)', category:'comfort', qty:flat(1), cond:t=>['plane','train'].includes(t.travelMode) },
  ...
  { id:'co10',name:'Melatonin / sleep aid',   category:'comfort', qty:flat(1),      cond:t=>t.isInternational||t.travelMode==='plane' },

  // TRANSPORT
  { id:'tr1', name:'Online check-in (24h before flight)', category:'transport', qty:flat(1), cond:t=>t.travelMode==='plane' },
  { id:'tr2', name:'Car GPS / phone mount',   category:'transport', qty:flat(1), cond:t=>t.travelMode==='car' },
  { id:'tr3', name:'Transit card / local pass', category:'transport', qty:perPerson(1), cond:t=>['train','bus'].includes(t.travelMode)||t.activities.includes('sightseeing') },
  { id:'tr4', name:'Cruise boarding pass & docs', category:'transport', qty:flat(1), cond:t=>t.accommodation==='cruise'||t.travelMode==='cruise' },
  { id:'tr5', name:'Rental car confirmation', category:'transport', qty:flat(1), cond:t=>t.travelMode==='car'&&t.isInternational },
];
